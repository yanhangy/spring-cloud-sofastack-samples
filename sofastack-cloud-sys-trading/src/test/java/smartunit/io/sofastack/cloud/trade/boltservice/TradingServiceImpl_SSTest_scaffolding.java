...
public class TradingServiceImpl_SSTest_scaffolding {
    ...
    private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException {
        mock(Class.forName("io.sofastack.cloud.common.model.TradingContext", false,
            TradingServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("io.sofastack.cloud.trade.dao.TradingOrderDao", false,
            TradingServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("java.util.Date", false,
            TradingServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
    }
    ...
    private static void initializeClasses() {
        org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(
            TradingServiceImpl_SSTest_scaffolding.class.getClassLoader(), "");
    }
