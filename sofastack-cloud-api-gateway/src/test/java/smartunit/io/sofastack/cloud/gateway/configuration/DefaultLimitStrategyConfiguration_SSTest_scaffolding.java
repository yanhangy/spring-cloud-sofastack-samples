...
public class DefaultLimitStrategyConfiguration_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "io.sofastack.cloud.gateway.configuration.DefaultLimitStrategyConfiguration"; 
  ...
  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(DefaultLimitStrategyConfiguration_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DefaultLimitStrategyConfiguration_SSTest_scaffolding.class.getClassLoader()); 
