...
public class SOFACloudGatewayApplication_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "io.sofastack.cloud.gateway.SOFACloudGatewayApplication"; 
  ...
  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(SOFACloudGatewayApplication_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SOFACloudGatewayApplication_SSTest_scaffolding.class.getClassLoader()); 
