...
public class GatewayConfiguration_SSTest_scaffolding {
    ...
    private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException {
        mock(Class.forName("org.springframework.beans.factory.ObjectProvider", false,
            GatewayConfiguration_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("org.springframework.http.codec.ServerCodecConfigurer", false,
            GatewayConfiguration_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
    }
    ...
    private static void initializeClasses() {
        org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(
            GatewayConfiguration_SSTest_scaffolding.class.getClassLoader(), "");
    }
