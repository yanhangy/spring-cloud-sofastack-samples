...
public class GatewayConfiguration_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "io.sofastack.cloud.gateway.configuration.GatewayConfiguration"; 
  ...
  public static void setSystemProperties() {
    ...
    java.lang.System.setProperties((java.util.Properties) defaultProperties.clone()); 
    java.lang.System.setProperty("sun.java.command", "org.smartunit.ClientProcess Client-0"); 
    java.lang.System.setProperty("java.io.tmpdir", "/tmp"); 
  }
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.springframework.beans.factory.ObjectProvider", false, GatewayConfiguration_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.http.codec.ServerCodecConfigurer", false, GatewayConfiguration_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(GatewayConfiguration_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GatewayConfiguration_SSTest_scaffolding.class.getClassLoader()); 
