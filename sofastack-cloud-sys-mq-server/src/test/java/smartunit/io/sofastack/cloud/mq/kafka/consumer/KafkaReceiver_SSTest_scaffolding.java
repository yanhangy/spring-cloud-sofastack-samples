...
public class KafkaReceiver_SSTest_scaffolding {
    ...
    private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException {
        mock(Class.forName("org.apache.kafka.clients.consumer.ConsumerRecord", false,
            KafkaReceiver_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    }

    private static void initializeClasses() {
        org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(
            KafkaReceiver_SSTest_scaffolding.class.getClassLoader(), "");
    }
