...
public class TradeService_SSTest_scaffolding {
    ...
    private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException {
        mock(Class.forName("io.sofastack.cloud.common.model.TradingContext", false,
            TradeService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
        ...
        mock(Class.forName("io.sofastack.cloud.common.response.Result", false,
            TradeService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
        mock(Class.forName("io.sofastack.cloud.facade.trading.TradingService", false,
            TradeService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    }

    private static void initializeClasses() {
        org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(
            TradeService_SSTest_scaffolding.class.getClassLoader(), "");
    }
