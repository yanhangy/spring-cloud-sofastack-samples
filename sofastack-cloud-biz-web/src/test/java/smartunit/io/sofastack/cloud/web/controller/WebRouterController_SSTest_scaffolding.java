...
public class WebRouterController_SSTest_scaffolding {
    ...
    private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException {
        mock(Class.forName("io.sofastack.cloud.common.model.BalanceDetails", false,
            WebRouterController_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("io.sofastack.cloud.common.model.TradingOrder", false,
            WebRouterController_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("io.sofastack.cloud.common.model.UserDetails", false,
            WebRouterController_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("io.sofastack.cloud.common.response.Result", false,
            WebRouterController_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("io.sofastack.cloud.web.service.AccountService", false,
            WebRouterController_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("io.sofastack.cloud.web.service.TradeService", false,
            WebRouterController_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("io.sofastack.cloud.web.service.UserService", false,
            WebRouterController_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("javax.servlet.http.HttpServletRequest", false,
            WebRouterController_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("org.springframework.ui.ModelMap", false,
            WebRouterController_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("org.springframework.web.servlet.ModelAndView", false,
            WebRouterController_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
    }
    ...
    private static void initializeClasses() {
        org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(
            WebRouterController_SSTest_scaffolding.class.getClassLoader(), "");
    }
