...
public class AccountService_SSTest_scaffolding {
    ...
    private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException {
        mock(Class.forName("io.sofastack.cloud.common.model.BalanceDetails", false,
            AccountService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
        mock(Class.forName("io.sofastack.cloud.common.response.Result", false,
            AccountService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
        mock(Class.forName("io.sofastack.cloud.rest.facade.AccountingService", false,
            AccountService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    ...
    private static void initializeClasses() {
        org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(
            AccountService_SSTest_scaffolding.class.getClassLoader(), "");
    }
