...
public class AuthController_SSTest_scaffolding {
    ...
    private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException {
        mock(Class.forName("io.sofastack.cloud.auth.model.AuthRequest", false,
            AuthController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
        mock(Class.forName("io.sofastack.cloud.auth.model.RegisterRequest", false,
            AuthController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
        mock(Class.forName("io.sofastack.cloud.auth.service.AccountService", false,
            AuthController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
        mock(Class.forName("io.sofastack.cloud.auth.service.UserService", false,
            AuthController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
        ...
        mock(Class.forName("javax.servlet.http.HttpServletRequest", false,
            AuthController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
        mock(Class.forName("javax.servlet.http.HttpSession", false,
            AuthController_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    }

    private static void initializeClasses() {
        org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(
            AuthController_SSTest_scaffolding.class.getClassLoader(), "");
    }
