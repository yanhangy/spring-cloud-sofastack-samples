...
// allCoveredLines:[28, 40, 42, 43, 44, 45, 48, 49, 50, 51, 53, 54, 55, 56, 58, 60, 61, 62, 63, 64, 69, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 91, 92, 93, 94, 95, 96]
  ...
  public void test_register_0()  throws Throwable  {
      ...
      doReturn("org.apache.commons.io.filefilter.CanWriteFileFilter").when(registerRequest0).getEmail();
      doReturn("org.apache.commons.io.filefilter.CanWriteFileFilter", "org.apache.commons.io.filefilter.CanWriteFileFilter").when(registerRequest0).getPassword();
      doReturn("org.apache.commons.io.filefilter.CanWriteFileFilter", "org.apache.commons.io.filefilter.CanWriteFileFilter").when(registerRequest0).getUserName();
  ...
  public void test_valid_4()  throws Throwable  {
      ...
      //mock result1
      Result<String> result1 = (Result<String>) mock(Result.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      //mock httpSession0
      HttpSession httpSession0 = mock(HttpSession.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
  ...
  public void test_valid_7()  throws Throwable  {
      ...
      doReturn("Failed to register user;", "Failed to register user;").when(authRequest0).getUserName();
