...
public class DailyOrderSchedulerConfiguration_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "io.sofastack.cloud.accounting.configuration.DailyOrderSchedulerConfiguration"; 
  ...
  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(DailyOrderSchedulerConfiguration_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DailyOrderSchedulerConfiguration_SSTest_scaffolding.class.getClassLoader()); 
