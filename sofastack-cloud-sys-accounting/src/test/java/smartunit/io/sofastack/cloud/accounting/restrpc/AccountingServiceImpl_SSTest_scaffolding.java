...
public class AccountingServiceImpl_SSTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("io.sofastack.cloud.common.model.SerialOrder", false, AccountingServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
