...
public class AccountingServiceImpl_SSTest_scaffolding {
    ...
    private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException {
        mock(Class.forName("io.sofastack.cloud.accounting.dao.AccountingMapper", false,
            AccountingServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("io.sofastack.cloud.accounting.dao.SerialOrderMapper", false,
            AccountingServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("io.sofastack.cloud.accounting.entity.AccountingEntity", false,
            AccountingServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("io.sofastack.cloud.common.model.SerialOrder", false,
            AccountingServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("io.sofastack.cloud.common.model.TransferRequest", false,
            AccountingServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
    ...
    private static void initializeClasses() {
        org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(
            AccountingServiceImpl_SSTest_scaffolding.class.getClassLoader(), "");
    }
