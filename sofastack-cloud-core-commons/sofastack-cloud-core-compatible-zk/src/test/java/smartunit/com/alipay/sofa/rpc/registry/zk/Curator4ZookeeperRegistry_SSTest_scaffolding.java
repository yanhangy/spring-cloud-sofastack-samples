...
public class Curator4ZookeeperRegistry_SSTest_scaffolding {
    ...
    private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException {
        ...
        mock(Class.forName("org.apache.curator.framework.CuratorFramework", false,
            Curator4ZookeeperRegistry_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("org.apache.curator.framework.api.ACLBackgroundPathAndBytesable", false,
            Curator4ZookeeperRegistry_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName("org.apache.curator.framework.api.CreateBuilder", false,
            Curator4ZookeeperRegistry_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
        mock(Class.forName(
            "org.apache.curator.framework.api.ProtectACLCreateModeStatPathAndBytesable", false,
            Curator4ZookeeperRegistry_SSTest_scaffolding.class.getClassLoader()), withSettings()
            .stubOnly());
    }
