...
// allCoveredLines:[181, 182, 184, 185, 186, 188, 190, 197, 198, 200, 201, 202, 203, 204, 205, 207, 209, 210, 211, 212, 213, 215, 224, 230, 231, 242, 243, 244, 246, 247, 250, 253, 254, 259, 260, 261, 262, 264, 265, 266, 270, 271, 272, 273, 295, 296, 297, 298, 300, 304, 308, 315, 324, 330, 331, 333, 334, 336, 338, 339, 340, 341, 343, 344, 345, 348, 373, 374, 376, 377, 387, 388, 390, 391, 393, 415, 416, 429, 430, 432, 433, 434, 461, 462, 469, 470, 472, 473, 475, 478, 500, 515, 520, 521, 522, 523, 527, 528, 530, 531, 533, 537, 539, 602, 611, 612, 634, 639, 641, 642, 652, 655, 657, 658, 659, 660, 663, 665, 666, 667, 668, 684, 689, 690, 691, 692, 695, 699, 700, 712, 713, 714, 723, 730]
  ...
  public void test_batchUnRegister_00()  throws Throwable  {
      ...
      ProviderConfig<Integer> providerConfig0 = (ProviderConfig<Integer>) mock(ProviderConfig.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
  ...
  public void test_batchUnSubscribe_04()  throws Throwable  {
      ...
      ZookeeperProviderObserver zookeeperProviderObserver0 = mock(ZookeeperProviderObserver.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      //mock map0
      Map<ConsumerConfig, String> map0 = (Map<ConsumerConfig, String>) mock(Map.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      
      PrivateAccess.setVariable((Class<?>) Curator4ZookeeperRegistry.class, curator4ZookeeperRegistry0, "consumerUrls", (Object) map0);
      
      PrivateAccess.setVariable((Class<?>) Curator4ZookeeperRegistry.class, curator4ZookeeperRegistry0, "providerObserver", (Object) zookeeperProviderObserver0);
      LinkedList<ConsumerConfig> linkedList0 = new LinkedList<ConsumerConfig>();
      //mock consumerConfig0
      ConsumerConfig consumerConfig0 = mock(ConsumerConfig.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn(true).when(consumerConfig0).isRegister();
      ...
      try { 
        curator4ZookeeperRegistry0.batchUnSubscribe(linkedList0);
         ...
         assertEquals("Failed to unsubscribe consumer config from zookeeperRegistry!", e.getMessage());
      }
  }
  ...
  public void test_recoverRegistryData_13()  throws Throwable  {
      ...
      //mock providerConfig0
      ProviderConfig providerConfig0 = mock(ProviderConfig.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("Failed to unsubscribe provider config from zookeeperRegistry!").when(providerConfig0).getAppName();
  ...
  public void test_register_14()  throws Throwable  {
      ...
      PrivateAccess.setVariable((Class<?>) Curator4ZookeeperRegistry.class, curator4ZookeeperRegistry0, "registryConfig", (Object) registryConfig0);
      //mock providerConfig0
      ProviderConfig<ConsumerConfig<ProviderGroup>> providerConfig0 = (ProviderConfig<ConsumerConfig<ProviderGroup>>) mock(ProviderConfig.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
  ...
  public void test_register_15()  throws Throwable  {
      ...
      PrivateAccess.setVariable((Class<?>) Curator4ZookeeperRegistry.class, curator4ZookeeperRegistry0, "registryConfig", (Object) registryConfig0);
      //mock providerConfig0
      ProviderConfig<String> providerConfig0 = (ProviderConfig<String>) mock(ProviderConfig.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
  ...
  public void test_subscribe_21()  throws Throwable  {
      ...
      PrivateAccess.setVariable((Class<?>) Curator4ZookeeperRegistry.class, curator4ZookeeperRegistry0, "registryConfig", (Object) registryConfig0);
      //mock consumerConfig0
      ConsumerConfig<Map.Entry<ChannelDuplexHandler, String>> consumerConfig0 = (ConsumerConfig<Map.Entry<ChannelDuplexHandler, String>>) mock(ConsumerConfig.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
  ...
  public void test_subscribeConfig_22()  throws Throwable  {
      ...
      ZookeeperConfigObserver zookeeperConfigObserver0 = mock(ZookeeperConfigObserver.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      
      PrivateAccess.setVariable((Class<?>) Curator4ZookeeperRegistry.class, curator4ZookeeperRegistry0, "configObserver", (Object) zookeeperConfigObserver0);
      //mock abstractInterfaceConfig0
      AbstractInterfaceConfig<ZookeeperRegistry, ProviderConfig<Object>> abstractInterfaceConfig0 = (AbstractInterfaceConfig<ZookeeperRegistry, ProviderConfig<Object>>) mock(AbstractInterfaceConfig.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
  ...
  public void test_subscribeConfig_23()  throws Throwable  {
      ...
      Curator4ZookeeperRegistry curator4ZookeeperRegistry0 = mock(Curator4ZookeeperRegistry.class, CALLS_REAL_METHODS);
      //mock abstractInterfaceConfig0
      AbstractInterfaceConfig<Object, ConsumerConfig<ProviderGroup>> abstractInterfaceConfig0 = (AbstractInterfaceConfig<Object, ConsumerConfig<ProviderGroup>>) mock(AbstractInterfaceConfig.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      //mock configListener0
      ConfigListener configListener0 = mock(ConfigListener.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
  ...
  public void test_subscribeOverride_24()  throws Throwable  {
      ...
      //mock consumerConfig0
      ConsumerConfig<ConsumerConfig<String>> consumerConfig0 = (ConsumerConfig<ConsumerConfig<String>>) mock(ConsumerConfig.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      //mock configListener0
      ConfigListener configListener0 = mock(ConfigListener.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
  ...
  public void test_subscribeOverride_25()  throws Throwable  {
      ...
      Curator4ZookeeperRegistry curator4ZookeeperRegistry0 = mock(Curator4ZookeeperRegistry.class, CALLS_REAL_METHODS);
      //mock consumerConfig0
      ConsumerConfig<ProviderGroup> consumerConfig0 = (ConsumerConfig<ProviderGroup>) mock(ConsumerConfig.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      //mock configListener0
      ConfigListener configListener0 = mock(ConfigListener.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
