...
public class KafkaProducerAutoConfiguration_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "io.sofastack.cloud.core.kafka.configuration.KafkaProducerAutoConfiguration"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.springframework.kafka.core.ProducerFactory", false, KafkaProducerAutoConfiguration_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(KafkaProducerAutoConfiguration_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(KafkaProducerAutoConfiguration_SSTest_scaffolding.class.getClassLoader()); 
